...
class SpeechToTextGUI(tk.Tk):
    def __init__(self):
        ...
        self.recorder = AudioToTextRecorder(spinner=False, model="small.en", language="en", enable_realtime_transcription=True, realtime_model_type="tiny.en", on_realtime_transcription_stabilized=self.update_text)
